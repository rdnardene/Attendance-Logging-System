...
def login():
    ...
    lbl_user = Label(root, text="Username:", font=("Goudy old style", 15, "bold"), fg="#000",bg="white").place(x=30, y=130)
    ...
    lbl_password = Label(root, text="Password:", font=("Goudy old style", 15, "bold"), fg="#000",bg="white").place(x=30, y=210)
...
def logged():
    def regester():
        ...
        show = Button(window3, text="Show Details", bd=5, command=show,
                      font=("Goudy old style", 15, "bold"), bg="#00cc5f", fg="black").place(x=10, y=25, width=150,height=40)
        ...
        lbl_course = Label(Frame_register, text="Course & Section:", font=("Goudy old style", 15, "bold"), fg="#000", bg="white").place(x=5, y=170)
        ...
        lbl_idnum = Label(Frame_register, text="ID Number:", font=("Goudy old style", 15, "bold"), fg="#000", bg="white").place(x=5, y=230)
        ...
        window3.btn_pic = Button(Frame_register, text="Upload File", bd=5, command=upload_file,
                                 font=("Goudy old style", 15, "bold"), bg="green", fg="#000").place(x=5, y=420,width=150, height=40)
        ...
        with open("Attendance\Attendance_" + date + ".csv", 'r') as csvFile1:
            ...
            for lines in reader1:
                ...
                if (i > 1):
                    if (i % 2 != 0):
                        iidd = str(lines[0]) + '   '
                        tb.insert('', 0, text=iidd, values=(str(lines[1]), str(lines[2]), str(lines[3]), str(lines[4]), str(lines[5]), str(lines[6])))
        csvFile1.close()
        cam.release()
        cv2.destroyAllWindows()
    ...
    Reports.add_command(label="Attendance Excel Files", command=lambda: File_dialog())
    ...
    tb = ttk.Treeview(frame2, height=20, columns=('name', 'mname', 'lname', 'course', 'date', 'time'), style="mystyle.Treeview")
...
def regerterstudent():
        ...
        if ((name.isalpha()) or (' ' in name)):
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("TrainingImage\ "  + course + "." + str(serial) + "." + yr + "." + str(serial) + "." + name + "." + str(serial) + "." + mname + "." + str(serial) +  "." + lname + "." + str(serial) + "." + Id + '.' + str(sampleNum) + ".jpg",
                                gray[y:y + h, x:x + w])
                    # display the frame
 ...
 # registretion frame
    ...
    txt4 = tkinter.Entry(frame1, width=32, textvariable='', fg="black", bg="#e1f2f2", highlightcolor="#00aeff",highlightthickness=3,font=('times', 15, ' bold '))
    ...
    txt5 = tkinter.Entry(frame1, width=32, textvariable='', fg="black", bg="#e1f2f2", highlightcolor="#00aeff", highlightthickness=3, font=('times', 15, ' bold '))
    ...
    lbl3 = tkinter.Label(frame1, text="Enter Course & Section:", font=("Goudy old style", 15, "bold"), fg="#000", bg="white")
    ...
    message2 = tkinter.Label(frame1, text="", bg="white", fg="black", width=39, height=1, activebackground="yellow", font=('times', 16, ' bold '))
...
def main_display():
    ...
    subimg = Label(root, bg="#00cc5f", image=root.subimg).place(x=0, y=40, width=500, height=500)
    ...
    Button(root, text="Exit", relief="groove", bd=8, font=("Goudy old style", 15, "bold"), bg="#00cc5f", fg="black",
           command=Exit).pack()
    Label(root, text="").pack()
